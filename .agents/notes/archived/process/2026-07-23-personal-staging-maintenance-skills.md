...
**Rebase the active staging checkout in place.** This is simpler but changes many files during preparation, can disrupt new cch launches, and cannot provide atomic publication or an unchanged rollback checkout.
