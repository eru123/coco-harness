...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`cch-archive-agent-notes`](../../skills/cch-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
