...
**Put Web wording in the global harness identity.** `cch-system-prompt` serves TUI, ACP, SDK, and custom deployments that do not run in a browser. The composing Web app owns this surface fact.
