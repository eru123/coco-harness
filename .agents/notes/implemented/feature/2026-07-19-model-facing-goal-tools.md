...
- Human slash-command discovery and rendering are owned by the separate [`cch-command-goal`](../../../../packages/goal/command-goal/README.md) plugin.
