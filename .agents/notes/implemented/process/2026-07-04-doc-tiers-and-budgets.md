...
- **A thin workflow skill, contracts in docs.** [.agents/skills/cch-doc-standards](../../../skills/cch-doc-standards/SKILL.md) carries the placement/audit/red-gate workflow and defers to the standard as its source of truth, the same split as [cch-translate-docs](../../../skills/cch-translate-docs/SKILL.md) over the i18n contract.
