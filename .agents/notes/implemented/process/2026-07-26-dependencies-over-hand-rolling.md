...
- Agents and contributors surveying for simplifications now treat "replace hand-rolled X with package Y" as in-scope output; [cch-find-simplifications](../../../skills/cch-find-simplifications/SKILL.md) carries the corresponding guidance.
