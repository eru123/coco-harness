...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [cch-find-simplifications](../cch-find-simplifications/SKILL.md)).
