...
| --- | --- | --- | --- |
| `@coco-harness/cosmokit` | `cosmokit` | [github.com/coco-harness/cosmokit](https://github.com/coco-harness/cosmokit) | MIT |
| `@coco-harness/schemastery` | `schemastery` | [github.com/coco-harness/schemastery](https://github.com/coco-harness/schemastery) | MIT |
| `@coco-harness/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@coco-harness/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@coco-harness/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/coco-harness/cordis](https://github.com/coco-harness/cordis) | MIT |
| `@coco-harness/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/coco-harness/cordis](https://github.com/coco-harness/cordis) | MIT |
| `@coco-harness/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/coco-harness/cordis](https://github.com/coco-harness/cordis) | MIT |
| `@coco-harness/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/coco-harness/cordis](https://github.com/coco-harness/cordis) | MIT |
| `@coco-harness/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/coco-harness/cordis](https://github.com/coco-harness/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any Coco Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `coco-harness-sdk` |
