...
// in the temp workspace) all run; the model adapter is cch-llm-replay (keyless)
...
// Record: CCH_SNAPSHOT=record rewrites session.jsonl, then a keyless
// CCH_SNAPSHOT=refresh regenerates ui.expected.md.
