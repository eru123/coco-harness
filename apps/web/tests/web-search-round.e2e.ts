...
import { WEB_SEARCH_MAX_RESULTS } from '@coco-harness/cch-tool-web'
import {
...
const QUERY = 'Coco Harness snapshot search'
const PROMPT = `Use web_search to search exactly "${QUERY}". Then reply exactly SEARCH_DONE and stop.`
const SEARCH_CREDENTIAL_REF = credentialRef('CCH_WEB_SEARCH_E2E_KEY')
