...
const STANDALONE_ERROR = 'apps/web is not a standalone application: bare Vite cannot inject window.__CCH_BOOT__. '
  + 'From a repository checkout, run `pnpm cch web`; an installed package uses `cch web`. '
  + 'For client-plugin HMR, run `pnpm cch web` together with `pnpm run dev:web`.'

/** Fail before a Vite dev or preview server can expose the boot-manifest-free shell. */
function rejectStandaloneServe(): Plugin {
  return {
    name: 'cch-reject-standalone-web-serve',
    config(_config, env) {
...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@coco-harness\/cch-client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@coco-harness\/cch-client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@coco-harness\/cch-client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@coco-harness\/cch-client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@coco-harness\/cch-client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@coco-harness\/cch-client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@coco-harness\/cch-client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {
