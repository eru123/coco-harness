...
<a id="coco-harnesscch-acp-demo"></a>
...
Depends on: [`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#coco-harnesscch-tools)

Source: [`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="coco-harnesscch-agent-default-model"></a>
...
<a id="coco-harnesscch-agent-instructions"></a>
...
<a id="coco-harnesscch-agent-loop"></a>

## `@coco-harness/cch-agent-loop`
...
## `@coco-harness/cch-agent-presets`
...
<a id="coco-harnesscch-agent-spine-demo"></a>
...
Depends on: [`AgentLoopConfig`](#coco-harnesscch-agent-loop) · [`GoalDomainConfig`](#coco-harnesscch-goal) · [`InvariantConfig`](#coco-harnesscch-invariants) · [`JobsConfig`](#coco-harnesscch-jobs-local) · [`SessionTitleConfig`](#coco-harnesscch-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#coco-harnesscch-skill) · [`SystemPromptConfig`](#coco-harnesscch-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#coco-harnesscch-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

Source: [`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="coco-harnesscch-agent-tool-presentation"></a>

## `@coco-harness/cch-agent-tool-presentation`
...
<a id="coco-harnesscch-attachment-local"></a>
...
<a id="coco-harnesscch-bash-local"></a>
...
<a id="coco-harnesscch-bash-sandbox"></a>
...
Depends on: [`LocalConfig`](#coco-harnesscch-bash-local)

Source: [`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)

<a id="coco-harnesscch-client-connection"></a>
...
<a id="coco-harnesscch-client-hmr"></a>
...
<a id="coco-harnesscch-code-runtime-worker-thread"></a>
...
<a id="coco-harnesscch-compaction-basic"></a>
...
<a id="coco-harnesscch-compaction-tool-result-pruner"></a>
...
<a id="coco-harnesscch-cordis-host-runner"></a>
...
<a id="coco-harnesscch-credentials-local"></a>

## `@coco-harness/cch-credentials-local`
...
<a id="coco-harnesscch-fs-local"></a>
...
<a id="coco-harnesscch-fs-sandbox"></a>

## `@coco-harness/cch-fs-sandbox`
...
<a id="coco-harnesscch-headless"></a>
...
<a id="coco-harnesscch-hooks-claude-code"></a>
...
<a id="coco-harnesscch-hooks-codex"></a>
...
<a id="coco-harnesscch-host-apiproxy"></a>

## `@coco-harness/cch-host-apiproxy`
...
<a id="coco-harnesscch-host-directory-picker-browse"></a>
...
<a id="coco-harnesscch-host-frontend-static"></a>
...
<a id="coco-harnesscch-host-webserver"></a>
...
<a id="coco-harnesscch-invariants"></a>

## `@coco-harness/cch-invariants`
...
<a id="coco-harnesscch-jobs-local"></a>
...
<a id="coco-harnesscch-llm-deepseek"></a>
...
<a id="coco-harnesscch-llm-replay"></a>
...
<a id="coco-harnesscch-llm-retry"></a>
...
<a id="coco-harnesscch-lsp-stdio"></a>
...
<a id="coco-harnesscch-mcp-client"></a>
...
<a id="coco-harnesscch-message-feedback"></a>
...
<a id="coco-harnesscch-permission-presets"></a>
...
<a id="coco-harnesscch-persona"></a>

## `@coco-harness/cch-persona`
...
<a id="coco-harnesscch-plan-mode"></a>
...
<a id="coco-harnesscch-pwsh-local"></a>
...
<a id="coco-harnesscch-pwsh-sandbox"></a>
...
Depends on: [`LocalConfig`](#coco-harnesscch-pwsh-local)

Source: [`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="coco-harnesscch-repeat-tool-reminder"></a>
...
<a id="coco-harnesscch-sandbox-local"></a>
...
<a id="coco-harnesscch-sandbox-policy"></a>
...
<a id="coco-harnesscch-session-persistence-jsonl"></a>
...
<a id="coco-harnesscch-session-persistence-sqlite"></a>
...
<a id="coco-harnesscch-session-projection-cache"></a>
...
<a id="coco-harnesscch-session-query-sqlite"></a>
...
<a id="coco-harnesscch-session-reference"></a>
...
<a id="coco-harnesscch-session-title-all-prompts-llm"></a>
...
<a id="coco-harnesscch-session-title-first-prompt-llm"></a>
...
<a id="coco-harnesscch-settings-file"></a>
...
<a id="coco-harnesscch-shell-env"></a>
...
<a id="coco-harnesscch-skill-filesystem"></a>
...
<a id="coco-harnesscch-spill-local"></a>
...
<a id="coco-harnesscch-spill-policy"></a>
...
<a id="coco-harnesscch-storage-domain"></a>
...
<a id="coco-harnesscch-storage-json"></a>
...
<a id="coco-harnesscch-storage-sqlite"></a>
...
<a id="coco-harnesscch-subagent-acp"></a>
...
<a id="coco-harnesscch-subagent-spawn-in-process"></a>
...
<a id="coco-harnesscch-subprocess-e2b"></a>

## `@coco-harness/cch-subprocess-e2b`
...
<a id="coco-harnesscch-system-prompt"></a>

## `@coco-harness/cch-system-prompt`
...
<a id="coco-harnesscch-terminal-bash"></a>
...
<a id="coco-harnesscch-time-context"></a>
...
<a id="coco-harnesscch-tmux-context"></a>
...
<a id="coco-harnesscch-token-meter"></a>
...
<a id="coco-harnesscch-tool-bash"></a>
...
<a id="coco-harnesscch-tool-fs"></a>
...
<a id="coco-harnesscch-tool-fs-search"></a>
...
<a id="coco-harnesscch-tool-goal"></a>
...
<a id="coco-harnesscch-tool-jobs"></a>
...
<a id="coco-harnesscch-tool-lsp"></a>
...
<a id="coco-harnesscch-tool-pwsh"></a>
...
<a id="coco-harnesscch-tool-ralph"></a>
...
<a id="coco-harnesscch-tool-session-query"></a>
...
<a id="coco-harnesscch-tool-skill"></a>
...
<a id="coco-harnesscch-tool-str-replace-editor"></a>
...
<a id="coco-harnesscch-tool-subagent"></a>
...
<a id="coco-harnesscch-tool-subagent-report"></a>
...
<a id="coco-harnesscch-tool-terminal"></a>
...
<a id="coco-harnesscch-tool-todo"></a>
...
<a id="coco-harnesscch-tool-web"></a>
...
<a id="coco-harnesscch-tool-workflow"></a>
...
<a id="coco-harnesscch-tools"></a>

## `@coco-harness/cch-tools`
...
<a id="coco-harnesscch-typert-loader"></a>
...
<a id="coco-harnesscch-user-approval"></a>
...
<a id="coco-harnesscch-web-app"></a>
...
<a id="coco-harnesscch-web-fetch-http"></a>
...
<a id="coco-harnesscch-web-search-deepseek"></a>
...
<a id="coco-harnesscch-web-search-exa"></a>
...
<a id="coco-harnesscch-web-search-perplexity"></a>
...
<a id="coco-harnesscch-workflow-worker-thread"></a>
...
- `@coco-harness/cch-agent` ([`packages/core/agent/src/index.ts`](../packages/core/agent/src/index.ts))
- `@coco-harness/cch-api-gateway` — requires `typert` ([`packages/api/gateway/src/index.ts`](../packages/api/gateway/src/index.ts))
- `@coco-harness/cch-api-remotes` ([`packages/api/remotes/src/index.ts`](../packages/api/remotes/src/index.ts))
- `@coco-harness/cch-client-locale` ([`packages/client/locale/src/index.ts`](../packages/client/locale/src/index.ts))
- `@coco-harness/cch-client-modules` — requires `webServer` · `loader` ([`packages/client/modules/src/index.ts`](../packages/client/modules/src/index.ts))
- `@coco-harness/cch-client-runtime` ([`packages/client/runtime/src/index.ts`](../packages/client/runtime/src/index.ts))
- `@coco-harness/cch-client-ui-agent-preset` ([`packages/client/ui-agent-preset/src/index.ts`](../packages/client/ui-agent-preset/src/index.ts))
- `@coco-harness/cch-client-ui-commands` ([`packages/client/ui-commands/src/index.ts`](../packages/client/ui-commands/src/index.ts))
- `@coco-harness/cch-client-ui-conversation` ([`packages/client/ui-conversation/src/index.ts`](../packages/client/ui-conversation/src/index.ts))
- `@coco-harness/cch-client-ui-cordis` ([`packages/extensions/ui-cordis/src/index.ts`](../packages/extensions/ui-cordis/src/index.ts))
- `@coco-harness/cch-client-ui-deliverables` — requires `systemPrompt` ([`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts))
...
- `@coco-harness/cch-client-ui-message-feedback` ([`packages/client/ui-message-feedback/src/index.ts`](../packages/client/ui-message-feedback/src/index.ts))
- `@coco-harness/cch-client-ui-model-selection` ([`packages/client/ui-model-selection/src/index.ts`](../packages/client/ui-model-selection/src/index.ts))
- `@coco-harness/cch-client-ui-permission-presets` ([`packages/client/ui-permission-presets/src/index.ts`](../packages/client/ui-permission-presets/src/index.ts))
- `@coco-harness/cch-client-ui-plan` ([`packages/client/ui-plan/src/index.ts`](../packages/client/ui-plan/src/index.ts))
- `@coco-harness/cch-client-ui-settings` ([`packages/client/ui-settings/src/index.ts`](../packages/client/ui-settings/src/index.ts))
- `@coco-harness/cch-client-ui-settings-general` ([`packages/client/ui-settings-general/src/index.ts`](../packages/client/ui-settings-general/src/index.ts))
- `@coco-harness/cch-client-ui-settings-models` ([`packages/client/ui-settings-models/src/index.ts`](../packages/client/ui-settings-models/src/index.ts))
- `@coco-harness/cch-client-ui-settings-plugin-inventory` ([`packages/client/ui-settings-plugin-inventory/src/index.ts`](../packages/client/ui-settings-plugin-inventory/src/index.ts))
- `@coco-harness/cch-client-ui-settings-plugins` ([`packages/client/ui-settings-plugins/src/index.ts`](../packages/client/ui-settings-plugins/src/index.ts))
- `@coco-harness/cch-client-ui-sidebar` ([`packages/client/ui-sidebar/src/index.ts`](../packages/client/ui-sidebar/src/index.ts))
- `@coco-harness/cch-client-ui-skill` ([`packages/client/ui-skill/src/index.ts`](../packages/client/ui-skill/src/index.ts))
- `@coco-harness/cch-client-ui-subagent` ([`packages/client/ui-subagent/src/index.ts`](../packages/client/ui-subagent/src/index.ts))
- `@coco-harness/cch-client-ui-theme` ([`packages/client/ui-theme/src/index.ts`](../packages/client/ui-theme/src/index.ts))
- `@coco-harness/cch-client-ui-tool` ([`packages/client/ui-tool/src/index.ts`](../packages/client/ui-tool/src/index.ts))
- `@coco-harness/cch-client-ui-trajectory` ([`packages/client/ui-trajectory/src/index.ts`](../packages/client/ui-trajectory/src/index.ts))
- `@coco-harness/cch-client-ui-user-questions` ([`packages/client/ui-user-questions/src/index.ts`](../packages/client/ui-user-questions/src/index.ts))
- `@coco-harness/cch-client-ui-workflow-run` ([`packages/client/ui-workflow-run/src/index.ts`](../packages/client/ui-workflow-run/src/index.ts))
- `@coco-harness/cch-client-ui-workspace` ([`packages/client/ui-workspace/src/index.ts`](../packages/client/ui-workspace/src/index.ts))
- `@coco-harness/cch-command-compact` — requires `commands` · `compaction` ([`packages/compaction/command-compact/src/index.ts`](../packages/compaction/command-compact/src/index.ts))
- `@coco-harness/cch-command-feedback` — requires `commands` ([`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts))
- `@coco-harness/cch-command-goal` — requires `commands` · `goals` ([`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts))
- `@coco-harness/cch-commands` ([`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts))
- `@coco-harness/cch-cordis-client-runner` ([`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts))
- `@coco-harness/cch-fs-e2b` — requires `e2b` ([`packages/e2b/fs-e2b/src/index.ts`](../packages/e2b/fs-e2b/src/index.ts))
- `@coco-harness/cch-fs-observation-policy` ([`packages/fs/fs-observation-policy/src/index.ts`](../packages/fs/fs-observation-policy/src/index.ts))
- `@coco-harness/cch-goal-round-driver` — requires `agents` · `goals` · `sessions` ([`packages/goal/goal-round-driver/src/index.ts`](../packages/goal/goal-round-driver/src/index.ts))
- `@coco-harness/cch-host-directory-picker-auto` — requires `webServer` · `loader` ([`packages/host/directory-picker-auto/src/index.ts`](../packages/host/directory-picker-auto/src/index.ts))
- `@coco-harness/cch-host-directory-picker-native` ([`packages/host/directory-picker-native/src/index.ts`](../packages/host/directory-picker-native/src/index.ts))
- `@coco-harness/cch-host-plugin-inventory` — requires `loader` ([`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts))
- `@coco-harness/cch-llm` ([`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts))
- `@coco-harness/cch-lsp` ([`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts))
- `@coco-harness/cch-schedule` — requires `agents` · `sessions` · `tools` · `sessionPersistence` ([`packages/schedule/schedule/src/index.ts`](../packages/schedule/schedule/src/index.ts))
- `@coco-harness/cch-session` ([`packages/core/session/src/index.ts`](../packages/core/session/src/index.ts))
- `@coco-harness/cch-session-checkpoint-policy` — requires `llm` · `sessionPersistence` · `sessions` · `tools` ([`packages/session/session-checkpoint-policy/src/index.ts`](../packages/session/session-checkpoint-policy/src/index.ts))
- `@coco-harness/cch-session-log-export` — requires `commands` ([`packages/session-query/session-log-export/src/index.ts`](../packages/session-query/session-log-export/src/index.ts))
- `@coco-harness/cch-session-projection` ([`packages/session/session-projection/src/index.ts`](../packages/session/session-projection/src/index.ts))
- `@coco-harness/cch-session-stats` — requires `sessionProjections` ([`packages/session/session-stats/src/index.ts`](../packages/session/session-stats/src/index.ts))
- `@coco-harness/cch-skill-badge` — requires `skills` ([`packages/skill/skill-badge/src/index.ts`](../packages/skill/skill-badge/src/index.ts))
- `@coco-harness/cch-storage` ([`packages/storage/storage/src/index.ts`](../packages/storage/storage/src/index.ts))
- `@coco-harness/cch-subagent` ([`packages/subagent/subagent/src/index.ts`](../packages/subagent/subagent/src/index.ts))
- `@coco-harness/cch-subprocess-local` ([`packages/subprocess/subprocess-local/src/index.ts`](../packages/subprocess/subprocess-local/src/index.ts))
- `@coco-harness/cch-terminal` ([`packages/terminal/terminal/src/index.ts`](../packages/terminal/terminal/src/index.ts))
- `@coco-harness/cch-tool-ask-user` — requires `tools` · `userQuestions` ([`packages/interaction/tool-ask-user/src/index.ts`](../packages/interaction/tool-ask-user/src/index.ts))
- `@coco-harness/cch-tool-call-timeout-policy` — requires `tools` ([`packages/guard/timeout-policy/src/index.ts`](../packages/guard/timeout-policy/src/index.ts))
- `@coco-harness/cch-tool-cordis` — requires `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect` ([`packages/extensions/tool-cordis/src/index.ts`](../packages/extensions/tool-cordis/src/index.ts))
- `@coco-harness/cch-tool-subagent-control` — requires `tools` · `subagents` ([`packages/subagent/tool-subagent-control/src/index.ts`](../packages/subagent/tool-subagent-control/src/index.ts))
- `@coco-harness/cch-user-questions` ([`packages/interaction/user-questions/src/index.ts`](../packages/interaction/user-questions/src/index.ts))
- `@coco-harness/cch-workspace` — requires `storageDomain` · `sessionPersistence` ([`packages/workspace/workspace/src/index.ts`](../packages/workspace/workspace/src/index.ts))

## Seam packages (not directly loadable)

Abstract service classes — a deployment loads a concrete implementation package instead ([capability seams](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.md)).

- `@coco-harness/cch-attachment` — abstract `AttachmentStore` ([`packages/attachment/attachment/src/index.ts`](../packages/attachment/attachment/src/index.ts))
- `@coco-harness/cch-code-runtime` — abstract `CodeRuntime` ([`packages/code-runtime/code-runtime/src/index.ts`](../packages/code-runtime/code-runtime/src/index.ts))
- `@coco-harness/cch-compaction` — abstract `CompactionEngine` ([`packages/compaction/compaction/src/index.ts`](../packages/compaction/compaction/src/index.ts))
- `@coco-harness/cch-credentials` — abstract `CredentialProvider` ([`packages/credentials/credentials/src/index.ts`](../packages/credentials/credentials/src/index.ts))
- `@coco-harness/cch-fs` — abstract `FileSystem` ([`packages/fs/fs/src/index.ts`](../packages/fs/fs/src/index.ts))
- `@coco-harness/cch-host-directory-picker` — abstract `DirectoryPicker` ([`packages/host/directory-picker/src/index.ts`](../packages/host/directory-picker/src/index.ts))
- `@coco-harness/cch-jobs` — abstract `JobRegistry` ([`packages/jobs/jobs/src/index.ts`](../packages/jobs/jobs/src/index.ts))
- `@coco-harness/cch-sandbox` — abstract `SandboxProvider` ([`packages/sandbox/sandbox/src/index.ts`](../packages/sandbox/sandbox/src/index.ts))
- `@coco-harness/cch-session-persistence` — abstract `SessionPersistence` ([`packages/session/session-persistence/src/index.ts`](../packages/session/session-persistence/src/index.ts))
- `@coco-harness/cch-session-query` — abstract `SessionQueryEngine` ([`packages/session-query/session-query/src/index.ts`](../packages/session-query/session-query/src/index.ts))
- `@coco-harness/cch-settings` — abstract `SettingsProvider` ([`packages/settings/settings/src/index.ts`](../packages/settings/settings/src/index.ts))
- `@coco-harness/cch-shell` — abstract `ShellExecutor` ([`packages/shell/shell/src/index.ts`](../packages/shell/shell/src/index.ts))
- `@coco-harness/cch-spill` — abstract `SpillStore` ([`packages/spill/spill/src/index.ts`](../packages/spill/spill/src/index.ts))
- `@coco-harness/cch-subprocess` — abstract `SubprocessRuntime` ([`packages/subprocess/subprocess/src/index.ts`](../packages/subprocess/subprocess/src/index.ts))
- `@coco-harness/cch-workflow` — abstract `WorkflowEngine` ([`packages/workflow/workflow/src/index.ts`](../packages/workflow/workflow/src/index.ts))
...
- `@coco-harness/cch-brand` ([`packages/util/brand/src/index.ts`](../packages/util/brand/src/index.ts))
- `@coco-harness/cch-client-schema-form` ([`packages/client/schema-form/src/index.ts`](../packages/client/schema-form/src/index.ts))
- `@coco-harness/cch-client-test-runtime` ([`packages/test-support/client-runtime/src/index.ts`](../packages/test-support/client-runtime/src/index.ts))
- `@coco-harness/cch-client-ui-attachment` ([`packages/client/ui-attachment/src/index.ts`](../packages/client/ui-attachment/src/index.ts))
- `@coco-harness/cch-client-ui-primitives` ([`packages/client/ui-primitives/src/index.ts`](../packages/client/ui-primitives/src/index.ts))
- `@coco-harness/cch-client-ui-slots` ([`packages/client/ui-slots/src/index.ts`](../packages/client/ui-slots/src/index.ts))
- `@coco-harness/cch-client-web` ([`packages/client/web/src/index.ts`](../packages/client/web/src/index.ts))
- `@coco-harness/cch-client-web-react` ([`packages/client/web-react/src/index.ts`](../packages/client/web-react/src/index.ts))
- `@coco-harness/cch-cmdline` ([`packages/boot/cmdline/src/index.ts`](../packages/boot/cmdline/src/index.ts))
- `@coco-harness/cch-home-paths` ([`packages/util/home-paths/src/index.ts`](../packages/util/home-paths/src/index.ts))
- `@coco-harness/cch-hook-protocol` ([`packages/hooks/hook-protocol/src/index.ts`](../packages/hooks/hook-protocol/src/index.ts))
- `@coco-harness/cch-launch-environment` ([`packages/util/launch-environment/src/index.ts`](../packages/util/launch-environment/src/index.ts))
- `@coco-harness/cch-llm-mock-server` ([`packages/test-support/llm-mock-server/src/index.ts`](../packages/test-support/llm-mock-server/src/index.ts))
- `@coco-harness/cch-loader-smoke` ([`packages/test-support/loader-smoke/src/index.ts`](../packages/test-support/loader-smoke/src/index.ts))
- `@coco-harness/cch-native-command` ([`packages/util/native-command/src/index.ts`](../packages/util/native-command/src/index.ts))
- `@coco-harness/cch-output-retention` ([`packages/util/output-retention/src/index.ts`](../packages/util/output-retention/src/index.ts))
- `@coco-harness/cch-sandbox-windows-acl` ([`packages/sandbox/sandbox-windows-acl/src/index.ts`](../packages/sandbox/sandbox-windows-acl/src/index.ts))
- `@coco-harness/cch-scope` ([`packages/core/scope/src/index.ts`](../packages/core/scope/src/index.ts))
...
- `@coco-harness/cch-typert-generator` ([`packages/typert/generator/src/index.ts`](../packages/typert/generator/src/index.ts))
- `@coco-harness/cch-typert-protocol` ([`packages/typert/protocol/src/index.ts`](../packages/typert/protocol/src/index.ts))
- `@coco-harness/cch-typert-registry` ([`packages/typert/registry/src/index.ts`](../packages/typert/registry/src/index.ts))
