...
Click **Choose workspace**, add the project directory where you started `cch`, and select it. The session composer remains unavailable until a workspace is selected.
