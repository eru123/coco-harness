...
# export CCH_MODEL=deepseek-v4-flash
# export CCH_SYSTEM_PROMPT='You are a helpful software engineer assistant.'
```
...
| Session persistence | Uncompressed JSONL under `CCH_SESSION_ROOT` |
