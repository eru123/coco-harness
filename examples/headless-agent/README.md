...
pnpm cch --profile headless "fix the failing test in this workspace"
```

The product command is [`cch --profile headless`](../../apps/cli/README.md): it accepts one nonblank task, creates and persists a fresh session, prints the final assistant text, and exits.
