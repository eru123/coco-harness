...
This overlay opts one `cch web` process into Schedule reminders without changing the shipped default Web composition:

```sh
cch web --patch examples/web-schedule/cordis.yml
```
