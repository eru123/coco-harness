/**
 * Package-owned invariant companion for `@coco-harness/cch-api-gateway`.
 * @module @coco-harness/cch-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-api-gateway'
