...
import type { Agent, AgentOptions, AgentSetup } from '@coco-harness/cch-agent'
...
import type {} from '@coco-harness/cch-typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a cch-session-persistence backend)')
  }
