/** Local durable attachment backend rooted below `CCH_HOME`. @module @coco-harness/cch-attachment-local */
...
export interface Config {
  /** Explicit harness home; omitted follows `CCH_HOME`, then `~/.cch`. */
  cchHome?: string
