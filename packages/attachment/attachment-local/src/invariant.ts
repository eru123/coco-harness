/** Package-owned invariant companion for `@coco-harness/cch-attachment-local`. @module @coco-harness/cch-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'

const PACKAGE_NAME = '@coco-harness/cch-attachment-local'
