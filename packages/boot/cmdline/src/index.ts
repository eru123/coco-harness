/**
 * @coco-harness/cch-cmdline — the command line a cch launcher hands to the app
 * it boots.
 *
 ...
 * @module @coco-harness/cch-cmdline
 */
 ...
 * verbatim and in argv order. `cch --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
