...
import type {} from '@coco-harness/cch-attachment'
// Activates the webServer Context merge used below.
import type { WebRoute, WebUpgradeRoute } from '@coco-harness/cch-host-webserver'
import { toFetchHandler } from '@coco-harness/cch-host-apiproxy'
...
export interface ConnectionConfig {
   ...
   * by (the cch CLI derives the machine's LAN IP literals itself). An entry
