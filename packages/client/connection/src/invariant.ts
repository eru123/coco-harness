/**
 * Package-owned invariant companion for `@coco-harness/cch-client-connection`.
 * @module @coco-harness/cch-client-connection/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-connection'
