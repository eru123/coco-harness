/**
 * Package-owned invariant companion for `@coco-harness/cch-client-hmr`.
 * @module @coco-harness/cch-client-hmr/invariant
 */

import type { Context, Fiber } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'

const PACKAGE_NAME = '@coco-harness/cch-client-hmr'
