...
import type { WebBootGraph, ClientModuleRegistry } from '@coco-harness/cch-client-modules'
import type { WebRoute, WebServer } from '@coco-harness/cch-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'cch-hmr-')) })
