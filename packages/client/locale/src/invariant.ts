/**
 * Package-owned invariant companion for `@coco-harness/cch-client-locale`.
 * @module @coco-harness/cch-client-locale/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-locale'
