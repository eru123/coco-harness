 ...
 * Agent's identity. The mechanism mirrors the host `cch-scope` architecture
...
import type { TypertClientRemote, TypertRemoteScopeApi } from '@coco-harness/cch-typert-protocol'
...
const kScope = Symbol('cch.client.scope')
