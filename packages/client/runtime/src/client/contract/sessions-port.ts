...
import type { SessionId, WorkspaceId } from '@coco-harness/cch-api-remotes/client'
...
export interface SessionsPort {
   ...
   * @param opts - target workspace, or `mode: 'buddy'` for a workspace-less
   *   personal session.
   * @returns the new session id.
   */
  create(opts: { workspaceId: WorkspaceId } | { mode: 'buddy' }): Promise<SessionId>
  /**
