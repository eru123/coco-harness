...
// (`/types`, zero imports), never the package root: the root's cch-agent →
// cch-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@coco-harness/cch-session-projection/types'
