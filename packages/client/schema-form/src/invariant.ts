/**
 * Package-owned invariant companion for `@coco-harness/cch-client-schema-form`.
 * @module @coco-harness/cch-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-schema-form'
