/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-agent-preset`.
 * @module @coco-harness/cch-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-agent-preset'
