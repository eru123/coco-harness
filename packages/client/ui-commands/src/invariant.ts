/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-commands`.
 * @module @coco-harness/cch-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-commands'
