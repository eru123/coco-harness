...
import type { ConversationSnapshot, UseProjection } from '@coco-harness/cch-client-runtime/client'
import type { SnapshotSelectorHook } from '@coco-harness/cch-client-ui-slots'
// Type-only: merges the sessionStats key into SessionProjectionMap for useProjection.
import type {} from '@coco-harness/cch-session-stats/client'
import type { ContextPressureProjection, TokenUsageProjection } from '@coco-harness/cch-token-meter/client'
