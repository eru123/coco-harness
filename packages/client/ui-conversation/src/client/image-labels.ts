 ...
 * atoms' label props (`@coco-harness/cch-client-ui-attachment` reads no
...
} from '@coco-harness/cch-client-ui-attachment'
import type { ImageAttachmentLimits } from '@coco-harness/cch-attachment'
