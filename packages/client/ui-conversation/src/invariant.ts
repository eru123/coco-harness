/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-conversation`.
 * @module @coco-harness/cch-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-conversation'
