...
import { en as commonEn } from '@coco-harness/cch-client-locale/src/locales/index.ts'
...
describe('ContextMeter', () => {
  ...
  it('owns the headline word order around the reading', () => {
    const view = meter({
      contextPressure: { pressureTokens: 32_000, contextWindow: 128_000 },
      contextBreakdown: BREAKDOWN,
    })
    // The reading leads the label so the header reads as one sentence rather
