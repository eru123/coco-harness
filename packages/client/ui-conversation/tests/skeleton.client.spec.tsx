...
describe('Hero chrome', () => {
  it('renders the English headline through the hero locale seat', () => {
    ...
    expect(view.getByText("Nothing is baked in. That's the point.")).toBeTruthy()
  })
})
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText("Nothing is baked in. That's the point.")).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText("Nothing is baked in. That's the point.")).toBeNull()
  })
