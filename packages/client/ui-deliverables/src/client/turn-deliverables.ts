...
import { isAppendSurfaceEvent } from '@coco-harness/cch-client-runtime/client'
import type { MarkdownFileMentions } from '@coco-harness/cch-client-ui-primitives'
import type { TurnTailOwnerProps } from '@coco-harness/cch-client-ui-conversation/client'
...
declare module '@coco-harness/cch-client-runtime/client' {
