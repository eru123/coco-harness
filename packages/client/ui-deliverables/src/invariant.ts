/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-deliverables`.
 * @module @coco-harness/cch-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-deliverables'
