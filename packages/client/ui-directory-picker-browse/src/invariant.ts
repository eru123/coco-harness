/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-directory-picker-browse`.
 * @module @coco-harness/cch-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-directory-picker-browse'
