...
import type { DirectoryFlowOwnerProps } from '@coco-harness/cch-client-ui-workspace/client'
...
describe('directory-picker-browse client half', () => {
  ...
  it('rolls back the dictionary when a rival already owns the namespace en slot', async () => {
    const b = await bench()
    b.declare()
    ...
    try {
      ...
      // The dictionary registration rolled back with the failure: once the
      // rival leaves, a fresh registrant owns the whole namespace again.
      disposeRival()
