...
import type { GoalSnapshot } from '@coco-harness/cch-goal/client'
import {
...
export type GoalDockProps = import('@coco-harness/cch-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
