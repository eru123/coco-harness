/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-goal`.
 * @module @coco-harness/cch-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-goal'
