/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-graphs`.
 * @module @coco-harness/cch-client-ui-graphs/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-graphs'

/** Cordis companion plugin name. */
export const name = 'client-ui-graphs-invariant'
