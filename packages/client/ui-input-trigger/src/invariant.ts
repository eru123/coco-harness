/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-input-trigger`.
 * @module @coco-harness/cch-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-input-trigger'
