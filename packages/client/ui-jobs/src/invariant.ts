/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-jobs`.
 * @module @coco-harness/cch-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-jobs'
