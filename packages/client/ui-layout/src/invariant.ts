/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-layout`.
 * @module @coco-harness/cch-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-layout'
