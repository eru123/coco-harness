...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@coco-harness/cch-client-ui-theme/client'
import { apply, inject, LayoutController } from '@coco-harness/cch-client-ui-layout/client'
import { apply as nodeApply } from '@coco-harness/cch-client-ui-layout'
import * as invariant from '@coco-harness/cch-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@coco-harness/cch-client-ui-layout', expect.any(Function))
