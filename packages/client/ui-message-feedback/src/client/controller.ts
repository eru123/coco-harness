 ...
 * @module @coco-harness/cch-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@coco-harness/cch-typert-protocol'
import type { HostObservable } from '@coco-harness/cch-client-ui-slots'
import type { MessageId, SessionId } from '@coco-harness/cch-client-connection/client'
import type {
