/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-message-feedback`.
 * @module @coco-harness/cch-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-message-feedback'
