/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-model-selection`.
 * @module @coco-harness/cch-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-model-selection'
