/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-permission-presets`.
 * @module @coco-harness/cch-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-permission-presets'
