/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-primitives`.
 * @module @coco-harness/cch-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-primitives'
