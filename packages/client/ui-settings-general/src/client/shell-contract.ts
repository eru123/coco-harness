 ...
 */
import type { HostObservable, InjectFace, PropsRenderSlots, PropsRuntime } from '@coco-harness/cch-client-ui-slots'
// Type-only: pulls ui-sidebar's SlotMap merge (the 'sidebar.settings' entry)
// into every program that sees this contract.
import type {} from '@coco-harness/cch-client-ui-sidebar/client'
