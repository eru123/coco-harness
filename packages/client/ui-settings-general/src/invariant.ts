/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-settings-general`.
 * @module @coco-harness/cch-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-settings-general'
