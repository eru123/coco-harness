/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-settings-models`.
 * @module @coco-harness/cch-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-settings-models'
