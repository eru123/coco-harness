/** Package-owned invariant companion. @module @coco-harness/cch-client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'

const PACKAGE_NAME = '@coco-harness/cch-client-ui-settings-plugin-inventory'
