...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@coco-harness/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@coco-harness/cch-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
