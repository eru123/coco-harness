/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-settings-plugins`.
 * @module @coco-harness/cch-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-settings-plugins'
