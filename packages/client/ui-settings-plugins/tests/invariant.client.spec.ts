...
import * as PluginConfigInvariant from '@coco-harness/cch-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@coco-harness/cch-client-ui-settings-plugins')
