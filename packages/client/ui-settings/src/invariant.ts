/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-settings`.
 * @module @coco-harness/cch-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-settings'
