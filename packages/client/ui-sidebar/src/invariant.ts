/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-sidebar`.
 * @module @coco-harness/cch-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-sidebar'
