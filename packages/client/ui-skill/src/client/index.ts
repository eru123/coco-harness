 ...
 * determinism
 * lives host-side — the pre-step boundary (`cch-tool-skill`) recognizes a
...
import type { ConnectionHandle, SessionId, SkillEntry } from '@coco-harness/cch-api-remotes/client'
import type { ClientContext, ISessions } from '@coco-harness/cch-client-runtime/client'
import type { InputTriggerServiceContract, InputTriggerSource } from '@coco-harness/cch-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (cch-tool-skill) recognizes the leading /name and
