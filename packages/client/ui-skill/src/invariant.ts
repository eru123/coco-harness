/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-skill`.
 * @module @coco-harness/cch-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-skill'
