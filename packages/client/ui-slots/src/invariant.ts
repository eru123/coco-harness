/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-slots`.
 * @module @coco-harness/cch-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-slots'
