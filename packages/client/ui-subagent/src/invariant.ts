/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-subagent`.
 * @module @coco-harness/cch-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-subagent'
