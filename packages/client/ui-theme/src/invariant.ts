/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-theme`.
 * @module @coco-harness/cch-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-theme'
