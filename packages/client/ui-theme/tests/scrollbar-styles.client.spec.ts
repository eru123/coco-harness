...
const INDIRECTION_PREFIX = '--cch-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--cch-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--cch-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--cch-scrollbar-width)`); a rename in scrollbar.css without
