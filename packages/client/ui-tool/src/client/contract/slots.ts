...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@coco-harness/cch-client-ui-slots'
import type { ToolCallBlock } from '@coco-harness/cch-client-runtime/client'
