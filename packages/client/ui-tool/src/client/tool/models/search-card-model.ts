 ...
 * ({@link module:@coco-harness/cch-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@coco-harness/cch-client-ui-primitives'
