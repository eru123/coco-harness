 ...
 * @module
 */
import { resolveWorkspacePath } from '@coco-harness/cch-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@coco-harness/cch-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in cch-client-runtime), leaving a terminal
