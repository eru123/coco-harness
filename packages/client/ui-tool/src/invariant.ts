/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-tool`.
 * @module @coco-harness/cch-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-tool'
