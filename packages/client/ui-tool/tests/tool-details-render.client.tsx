...
import type { SessionProviderComponent, TranslateNS } from '@coco-harness/cch-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@coco-harness/cch-client-ui-conversation/src/client/contract/slots.ts'
