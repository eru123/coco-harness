/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-trajectory`.
 * @module @coco-harness/cch-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-trajectory'
