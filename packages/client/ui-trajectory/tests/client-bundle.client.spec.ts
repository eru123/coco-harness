 ...
 * not built (`pnpm --filter @coco-harness/cch-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@coco-harness/cch-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@coco-harness/cch-client-ui-primitives', await import('@coco-harness/cch-client-ui-primitives')],
    ])
