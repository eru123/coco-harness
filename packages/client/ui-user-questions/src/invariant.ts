/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-user-questions`.
 * @module @coco-harness/cch-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-user-questions'
