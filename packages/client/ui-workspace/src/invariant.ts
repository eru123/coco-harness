/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-workspace`.
 * @module @coco-harness/cch-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-workspace'
