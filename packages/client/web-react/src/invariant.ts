/**
 * Package-owned invariant companion for `@coco-harness/cch-client-web-react`.
 * @module @coco-harness/cch-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-web-react'
