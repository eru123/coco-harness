 ...
 * `window.__CCH_BOOT__` into the two-view BootManifest (wire boundary)
...
import * as ModulesClient from '@coco-harness/cch-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type CchWindow,
} from '@coco-harness/cch-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@coco-harness/cch-client-modules'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    this.manifest = parseBootManifest((globalThis as CchWindow).__CCH_BOOT__)
    ...
    ;(globalThis as CchWindow).__CCH_MODULES__ = this.modules
