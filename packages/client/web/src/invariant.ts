/**
 * Package-owned invariant companion for `@coco-harness/cch-client-web`.
 * @module @coco-harness/cch-client-web/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-web'
