 ...
 * @module @coco-harness/cch-client-web/src/loader-status
 */
import type { FiberState } from '@coco-harness/cordis'
 ...
 * while retaining its type (same rationale as cch-tool-cordis's mirror).
 */
