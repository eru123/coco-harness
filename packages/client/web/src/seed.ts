...
import * as Cordis from '@coco-harness/cordis'
import * as UiSlots from '@coco-harness/cch-client-ui-slots'
import * as WebReact from '@coco-harness/cch-client-web-react'
import * as UiPrimitives from '@coco-harness/cch-client-ui-primitives'
import * as UiAttachment from '@coco-harness/cch-client-ui-attachment'
import * as SchemaForm from '@coco-harness/cch-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@coco-harness/cordis': Cordis,
    '@coco-harness/cch-client-ui-slots': UiSlots,
    '@coco-harness/cch-client-web-react': WebReact,
    '@coco-harness/cch-client-ui-primitives': UiPrimitives,
    '@coco-harness/cch-client-ui-attachment': UiAttachment,
    '@coco-harness/cch-client-schema-form': SchemaForm,
