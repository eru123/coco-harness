/**
 * Package-owned invariant companion for `@coco-harness/cch-code-runtime-worker-thread`.
 * @module @coco-harness/cch-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-code-runtime-worker-thread'
