/** JSON string-prefix accounting for the outer-output ledger. @module @coco-harness/cch-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@coco-harness/cch-code-runtime'
