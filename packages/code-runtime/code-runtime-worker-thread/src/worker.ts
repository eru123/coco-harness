 ...
 * @module @coco-harness/cch-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('cch-code-runtime-worker-thread: worker entry loaded outside a worker thread')
