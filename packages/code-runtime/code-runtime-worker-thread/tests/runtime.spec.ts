...
import type { Config } from '@coco-harness/cch-code-runtime-worker-thread'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@coco-harness/cch-code-runtime'
...
describe('WorkerThreadCodeRuntime — seam misuse and lifecycle', () => {
  ...
  it('rejects malformed or colliding binding error-class declarations', async () => {
    ...
    await expect(runtime.run({ program: 'return 1', bindings: [{ global: '__cch_main__', functions: {} }] }))
