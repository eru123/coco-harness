/**
 * Package-owned invariant companion for `@coco-harness/cch-command-compact`.
 * @module @coco-harness/cch-command-compact/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-command-compact'
