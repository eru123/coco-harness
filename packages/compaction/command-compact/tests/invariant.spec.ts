...
import * as invariant from '@coco-harness/cch-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@coco-harness/cch-command-compact', expect.any(Function))
    expect(() => {
