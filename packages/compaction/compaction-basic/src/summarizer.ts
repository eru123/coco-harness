 ...
 *
 * @module @coco-harness/cch-compaction-basic/summarizer
 */

import type { Context } from '@coco-harness/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@coco-harness/cch-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'cch-compaction-basic' },
    }),
  ]
