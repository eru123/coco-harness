/**
 * Package-owned invariant companion for `@coco-harness/cch-compaction-tool-result-pruner`.
 * @module @coco-harness/cch-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-compaction-tool-result-pruner'
