 ...
 *
 * The seam itself lives in `@coco-harness/cch-compaction`, which re-exports these
 ...
 * `cch-commands/brand` shape.
 *
 * @module @coco-harness/cch-compaction/checkpoint
 */

import type { MessageSource } from '@coco-harness/cch-llm/message'
