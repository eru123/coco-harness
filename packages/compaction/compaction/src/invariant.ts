/** Package-owned compaction log-stream invariants. @module @coco-harness/cch-compaction/invariant */

import type { Context } from '@coco-harness/cordis'
import { isReplacementSurfaceEvent } from '@coco-harness/cch-session'
...
const PACKAGE_NAME = '@coco-harness/cch-compaction'
