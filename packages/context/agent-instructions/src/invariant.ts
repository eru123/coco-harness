/**
 * Package-owned invariant companion for `@coco-harness/cch-agent-instructions`.
 * @module @coco-harness/cch-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-agent-instructions'
