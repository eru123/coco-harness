 ...
 *
 * @module @coco-harness/cch-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$CCH_HOME`.
 * Discovery (`$CCH_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.cch/AGENTS.md' || displayPath === '$CCH_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
