 ...
 * @module @coco-harness/cch-agent-loop/invariant
 */

import type { Context } from '@coco-harness/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@coco-harness/cch-llm'
import type { InvariantFailure, InvariantInstaller } from '@coco-harness/cch-invariants'
import { foldRequestHeader } from '@coco-harness/cch-session'

const PACKAGE_NAME = '@coco-harness/cch-agent-loop'
