 ...
 * @module @coco-harness/cch-agent-loop/runtime-context
 */

import { createUserMessage } from '@coco-harness/cch-llm'
import type { ContextSnapshotSection } from '@coco-harness/cch-llm'
...
const SOURCE = '@coco-harness/cch-system-prompt'
