...
import ToolRuntime, { defineContentToolFixture, type PostToolDecision, type PreToolDecision } from '@coco-harness/cch-tools'
...
describe('worked example: a native hook plugin is just a cordis plugin on the seams', () => {
  // The whole point of the interception taxonomy: a "native hook" needs no cch-hook-protocol,
