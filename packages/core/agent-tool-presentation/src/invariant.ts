/**
 * Package-owned invariant companion for `@coco-harness/cch-agent-tool-presentation`.
 * @module @coco-harness/cch-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-agent-tool-presentation'
 ...
 * registry's to hold, and `cch-tools` observes it there.
 */
