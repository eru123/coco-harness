 ...
 * @module @coco-harness/cch-agent/dispatch
 */

import type { Context, Events } from '@coco-harness/cordis'
import { scopeTarget } from '@coco-harness/cch-scope'
import type { Scoped } from '@coco-harness/cch-scope'
import type { AssembleContext } from '@coco-harness/cch-system-prompt'
