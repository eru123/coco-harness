/** Package-owned scoped-dispatch invariants. @module @coco-harness/cch-scope/invariant */

import type { Context } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'
import { carrierKeyOf, isScopeCarrier } from '@coco-harness/cch-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@coco-harness/cch-scope'
