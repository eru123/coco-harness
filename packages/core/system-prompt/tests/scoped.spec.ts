...
import { createScope, scopeOf } from '@coco-harness/cch-scope'
import type { Scope, ScopeKey } from '@coco-harness/cch-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@coco-harness/cch-system-prompt'
import type { Config, PromptAssembly } from '@coco-harness/cch-system-prompt'
