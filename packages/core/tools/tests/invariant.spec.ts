...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@coco-harness/cch-tools'
import * as ToolsInvariant from '@coco-harness/cch-tools/invariant'
