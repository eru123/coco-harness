...
import { bindScopeParent, createScope } from '@coco-harness/cch-scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@coco-harness/cch-tools'
