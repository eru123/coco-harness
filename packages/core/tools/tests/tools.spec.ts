...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@coco-harness/cch-llm'
import SystemPrompt from '@coco-harness/cch-system-prompt'
import type { Agent } from '@coco-harness/cch-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@coco-harness/cch-user-approval'
import ToolRuntime, {
