/**
 * Package-owned invariant companion for `@coco-harness/cch-credentials-local`.
 * @module @coco-harness/cch-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-credentials-local'
...
/**
 * No runtime invariant: the Service Definition companion (`cch-credentials/invariant`) owns the
