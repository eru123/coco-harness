/**
 * Package-owned invariant companion for `@coco-harness/cch-credentials`.
 * @module @coco-harness/cch-credentials/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-credentials'
