/**
 * Package-owned invariant companion for `@coco-harness/cch-subprocess-e2b`.
 * @module @coco-harness/cch-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-subprocess-e2b'
