...
import type { SubprocessOutputRead, SubprocessOutputReader } from '@coco-harness/cch-subprocess'

const BASE64_TEXT = /^[A-Za-z0-9+/]+={0,2}$/u

/** Reserved non-base64 frame proving that one remote encoder reached clean EOF. */
export const E2B_OUTPUT_COMPLETE_FRAME = '!cch-e2b-output-complete!'
