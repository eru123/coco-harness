...
import type { SubprocessSpawnSpec } from '@coco-harness/cch-subprocess'
...
describe('E2BSubprocessHandle', () => {
  it('starts asynchronously, keeps secrets out of the command, and supports deferred piped stdin/output', async () => {
    ...
    }), '/workspace/.cch-e2b/processes/one')
    ...
    expect(fake.writtenFiles[0]).toEqual([
      '/workspace/.cch-e2b/processes/one/pid',
      '/workspace/.cch-e2b/processes/one/exit-code',
      '/workspace/.cch-e2b/processes/one/environment',
    ...
    expect(fake.removed).toContain('/workspace/.cch-e2b/processes/one/stderr.log')
