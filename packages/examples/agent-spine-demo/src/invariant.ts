/**
 * Package-owned invariant companion for `@coco-harness/cch-agent-spine-demo`.
 * @module @coco-harness/cch-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-agent-spine-demo'
