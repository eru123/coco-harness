/**
 * Package-owned invariant companion for `@coco-harness/cch-sdk-jsonrpc-demo`.
 * @module @coco-harness/cch-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-sdk-jsonrpc-demo'
