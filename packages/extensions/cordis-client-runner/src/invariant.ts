/**
 * Package-owned invariant companion for `@coco-harness/cch-cordis-client-runner`.
 * @module @coco-harness/cch-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-cordis-client-runner'
