 ...
 * @module @coco-harness/cch-cordis-host-runner/guard
 */

import { Context } from '@coco-harness/cordis'
import type { Plugin } from '@coco-harness/cordis'
import { scopeOf } from '@coco-harness/cch-scope'
import { assertSupportedJsonSchema, defineTool } from '@coco-harness/cch-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@coco-harness/cch-cordis-client-runner`, whose CTX_VERBS names this one its
