 ...
 * @module @coco-harness/cch-tool-cordis
 */
...
} from '@coco-harness/cch-cordis-host-runner'
import type { DynamicCordisReference } from '@coco-harness/cch-cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the CCH process restarted.',
