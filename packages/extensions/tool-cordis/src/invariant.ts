/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-cordis`.
 * @module @coco-harness/cch-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-cordis'
