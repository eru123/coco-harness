...
import type {} from '@coco-harness/cch-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@coco-harness/cch-client-ui-input-trigger/client'
