/**
 * Package-owned invariant companion for `@coco-harness/cch-client-ui-cordis`.
 * @module @coco-harness/cch-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-ui-cordis'
