/**
 * Package-owned invariant companion for `@coco-harness/cch-command-feedback`.
 * @module @coco-harness/cch-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-command-feedback'
