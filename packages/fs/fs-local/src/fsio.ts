 ...
 * streams large files, and rejects binary data; line windows belong to `cch-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @coco-harness/cch-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@coco-harness/cch-fs'
