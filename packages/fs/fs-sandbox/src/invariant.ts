/**
 * Package-owned invariant companion for `@coco-harness/cch-fs-sandbox`.
 * @module @coco-harness/cch-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-fs-sandbox'
