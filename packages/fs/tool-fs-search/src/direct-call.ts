/** Shared top-level-call post-policy selection for search result spill. @module cch-tool-fs-search/direct-call */

import type { Context } from '@coco-harness/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@coco-harness/cch-tools'
