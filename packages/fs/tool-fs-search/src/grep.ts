 ...
 *
 * @module @coco-harness/cch-tool-fs-search/grep
 */

import type { Context } from '@coco-harness/cordis'
import { defineTool } from '@coco-harness/cch-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@coco-harness/cch-tools'
import type { RetainedItems } from '@coco-harness/cch-output-retention'
import type { SpillRef } from '@coco-harness/cch-spill'
