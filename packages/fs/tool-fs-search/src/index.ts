 ...
 * ({@link module:@coco-harness/cch-tool-fs-search/glob} /
 * {@link module:@coco-harness/cch-tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @coco-harness/cch-tool-fs-search
 */
...
export interface Config {
   ...
   * `@coco-harness/cch-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
