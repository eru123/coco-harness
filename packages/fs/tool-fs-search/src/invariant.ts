/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-fs-search`.
 * @module @coco-harness/cch-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-fs-search'
