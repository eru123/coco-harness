 ...
 * @module @coco-harness/cch-tool-fs/src/write
 */

import type { Context } from '@coco-harness/cordis'
import { defineTool } from '@coco-harness/cch-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@coco-harness/cch-tools'
import type { FsWriteOutcome } from '@coco-harness/cch-fs'
