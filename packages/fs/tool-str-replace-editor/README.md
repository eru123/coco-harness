# @coco-harness/cch-tool-str-replace-editor
...
The generated [`str_replace_editor` schema](../../../docs/tool-catalog.md#coco-harnesscch-tool-str-replace-editor), including the configured `description`. The plugin contributes no standalone system-prompt section.
