/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-str-replace-editor`.
 * @module @coco-harness/cch-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-str-replace-editor'
