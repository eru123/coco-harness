# @coco-harness/cch-goal-round-driver
...
```yaml
- id: goal
  name: '@coco-harness/cch-goal'

- id: tool-goal
  name: '@coco-harness/cch-tool-goal'

- id: goal-round-driver
  name: '@coco-harness/cch-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`cch-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
