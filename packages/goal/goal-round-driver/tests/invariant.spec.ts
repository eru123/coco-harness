...
import * as GoalSessionInvariant from '@coco-harness/cch-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@coco-harness/cch-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@coco-harness/cch-goal-round-driver',
    }))
  })
