...
import { createUserMessage, HarnessError } from '@coco-harness/cch-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@coco-harness/cch-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@coco-harness/cch-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@coco-harness/cch-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@coco-harness/cch-session').SessionEvent[]): StubAgent {
