/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-goal`.
 * @module @coco-harness/cch-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-goal'
