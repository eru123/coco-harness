/**
 * Package-owned invariant companion for `@coco-harness/cch-repeat-tool-reminder`.
 * @module @coco-harness/cch-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-repeat-tool-reminder'
