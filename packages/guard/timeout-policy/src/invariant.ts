/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-call-timeout-policy`.
 * @module @coco-harness/cch-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-call-timeout-policy'
