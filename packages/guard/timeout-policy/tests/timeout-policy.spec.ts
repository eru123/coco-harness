/**
 * Unit + real-load-path coverage for @coco-harness/cch-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@coco-harness/cch-llm'
import SystemPrompt from '@coco-harness/cch-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@coco-harness/cch-tools'
import * as timeoutPolicy from '@coco-harness/cch-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@coco-harness/cch-tool-call-timeout-policy'
...
describe('cch-tool-call-timeout-policy real-load-path guard', () => {
