/** Package-owned hook invocation/result stream invariants. @module @coco-harness/cch-hook-protocol/invariant */
...
const PACKAGE_NAME = '@coco-harness/cch-hook-protocol'
