 ...
 * mapping; shared execution and parsing live in `cch-hook-protocol`.
 ...
 * @module @coco-harness/cch-hooks-claude-code
 */
...
import type { UserMessage } from '@coco-harness/cch-session'
import type {} from '@coco-harness/cch-session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@coco-harness/cch-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@coco-harness/cch-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@coco-harness/cch-subagent'
