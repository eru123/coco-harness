/**
 * Package-owned invariant companion for `@coco-harness/cch-hooks-claude-code`.
 * @module @coco-harness/cch-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-hooks-claude-code'
