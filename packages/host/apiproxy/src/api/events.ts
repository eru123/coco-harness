...
import type { AskUserQuestionItem } from '@coco-harness/cch-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@coco-harness/cch-user-approval/types'
import type { Message } from '@coco-harness/cch-llm/types'
import type { MessageId } from '@coco-harness/cch-llm/brand'
import type { CallId } from '@coco-harness/cch-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@coco-harness/cch-session/types'
import type { ToolCallView, ToolResultView } from '@coco-harness/cch-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// cch-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@coco-harness/cch-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
