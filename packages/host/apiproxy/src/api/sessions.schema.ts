...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@coco-harness/cch-attachment'
 ...
 * the cch-tools vocabulary into this schema and drift with it.
 */
