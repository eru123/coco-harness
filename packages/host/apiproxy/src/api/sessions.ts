...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@coco-harness/cch-attachment'
import type { ContentBlock } from '@coco-harness/cch-llm/types'
import type { SessionEvent, SessionId } from '@coco-harness/cch-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via cch-agent) must not enter client aggregates.
