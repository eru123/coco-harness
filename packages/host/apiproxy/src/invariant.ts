/**
 * Package-owned invariant companion for `@coco-harness/cch-host-apiproxy`.
 * @module @coco-harness/cch-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-host-apiproxy'
