 ...
 * @module @coco-harness/cch-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@coco-harness/cch-host-directory-picker-native',
  browse: '@coco-harness/cch-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@coco-harness/cch-client-ui-directory-picker-native',
  browse: '@coco-harness/cch-client-ui-directory-picker-browse',
}
