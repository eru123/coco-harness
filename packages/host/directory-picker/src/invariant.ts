/** Package-owned invariant companion for the directory-picker seam. @module @coco-harness/cch-host-directory-picker/invariant */

import type { Context } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'

const PACKAGE_NAME = '@coco-harness/cch-host-directory-picker'
