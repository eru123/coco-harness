/**
 * Package-owned invariant companion for `@coco-harness/cch-host-frontend-static`.
 * @module @coco-harness/cch-host-frontend-static/invariant
 */

import type { Context } from '@coco-harness/cordis'
import type { InvariantInstaller } from '@coco-harness/cch-invariants'

const PACKAGE_NAME = '@coco-harness/cch-host-frontend-static'
