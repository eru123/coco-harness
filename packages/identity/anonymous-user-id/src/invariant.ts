/**
 * Package-owned invariant companion for `@coco-harness/cch-anonymous-user-id`.
 * @module @coco-harness/cch-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-anonymous-user-id'
