/**
 * cch-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@coco-harness/cch-brand`; this module
 ...
 * loading the host plugin's Context merges — the `cch-llm/brand` shape.
 *
 * @module @coco-harness/cch-commands/brand
 */
