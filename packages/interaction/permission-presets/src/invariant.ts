/** Package-owned permission-preset event invariants. @module @coco-harness/cch-permission-presets/invariant */
...
const PACKAGE_NAME = '@coco-harness/cch-permission-presets'
