/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-ask-user`.
 * @module @coco-harness/cch-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-ask-user'
