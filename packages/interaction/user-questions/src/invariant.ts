/**
 * Package-owned invariant companion for `@coco-harness/cch-user-questions`.
 * @module @coco-harness/cch-user-questions/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-user-questions'
