/**
 * Package-owned invariant companion for `@coco-harness/cch-jobs-local`.
 * @module @coco-harness/cch-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-jobs-local'
...
/**
 * No runtime invariant: `@coco-harness/cch-jobs/invariant` owns per-snapshot identity, status,
