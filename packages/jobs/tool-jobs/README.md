...
The generated [`job_output`, `job_list`, and `job_kill` schemas](../../../docs/tool-catalog.md#coco-harnesscch-tool-jobs) while this tool set is visible.
