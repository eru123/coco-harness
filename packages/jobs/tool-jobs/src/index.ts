 ...
 * @module @coco-harness/cch-tool-jobs
 */

import type { Context } from '@coco-harness/cordis'
import z from '@coco-harness/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@coco-harness/cch-llm'
import { TextRetainer } from '@coco-harness/cch-output-retention'
import { defineTool } from '@coco-harness/cch-tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@coco-harness/cch-tools'
