/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-jobs`.
 * @module @coco-harness/cch-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-jobs'
