...
import AgentRegistry, { emitAgentEvent } from '@coco-harness/cch-agent'
...
import type { JobHooks, JobOutcome, JobSnapshot, JobStart } from '@coco-harness/cch-jobs'
import * as ToolTasks from '@coco-harness/cch-tool-jobs'
import { statusLine } from '@coco-harness/cch-tool-jobs'
