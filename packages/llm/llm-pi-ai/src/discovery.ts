 ...
 *
 * @module cch-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@coco-harness/cch-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@coco-harness/cch-llm'
import { attributionHeaders } from '@coco-harness/cch-llm'
 ...
 * on the length the server claims — the same two-stage shape `cch-web-fetch`
