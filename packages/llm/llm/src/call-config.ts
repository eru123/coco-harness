 ...
 * @module cch-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by cch-agent-loop. */
...
/**
 * Mark one exact request object as assembled by cch-agent-loop.
...
/**
 * Test whether the exact request object was assembled by cch-agent-loop.
