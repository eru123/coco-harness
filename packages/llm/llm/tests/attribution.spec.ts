...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@coco-harness/cch-llm'
import type { AppIdentity } from '@coco-harness/cch-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `coco-harness/${manifest.version} (+https://github.com/eru123/coco-harness)`,
    )
  })
