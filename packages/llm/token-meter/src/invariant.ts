/**
 * Package-owned invariant companion for `@coco-harness/cch-token-meter`.
 * @module @coco-harness/cch-token-meter/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-token-meter'
