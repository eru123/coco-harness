/**
 * Package-owned invariant companion for `@coco-harness/cch-lsp-stdio`.
 * @module @coco-harness/cch-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-lsp-stdio'
