...
import { LspInstance, readHostSource } from '@coco-harness/cch-lsp-stdio'
import { encodeMessage } from '@coco-harness/cch-lsp-stdio'
import type { ConnectionWriter } from '@coco-harness/cch-lsp-stdio/src/connection.ts'
import type { InstanceSpec } from '@coco-harness/cch-lsp-stdio/src/instance.ts'
import type { LspProviderQuery, LspQueryResult } from '@coco-harness/cch-lsp'
import { scrubbedParentEnv } from '@coco-harness/cch-subprocess'
import { spawnSubprocess } from '@coco-harness/cch-subprocess-local/src/spawn.ts'
