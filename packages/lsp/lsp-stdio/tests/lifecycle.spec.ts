...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@coco-harness/cch-lsp'
import { deadline } from '@coco-harness/cch-timeout'
...
import * as LspLocal from '@coco-harness/cch-lsp-stdio'
import type { LspLocalServerConfig } from '@coco-harness/cch-lsp-stdio'
