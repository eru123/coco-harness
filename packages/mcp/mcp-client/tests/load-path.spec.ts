/**
 * Real-load-path guard for @coco-harness/cch-mcp-client. `mcp-client` is a
...
import * as mcpClient from '@coco-harness/cch-mcp-client'

describe('cch-mcp-client real-load-path guard', () => {
