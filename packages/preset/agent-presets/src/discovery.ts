 ...
 * @module @coco-harness/cch-agent-presets/discovery
 */
...
import { expandHomePath } from '@coco-harness/cch-home-paths'
 ...
 *
 * This package owns the writable root the way `cch-skill-filesystem` owns
 * `<cchHome>/skills`. An app must assemble the SHIPPED root, whose path only
