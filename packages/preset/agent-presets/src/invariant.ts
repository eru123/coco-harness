/**
 * Package-owned invariant companion for `@coco-harness/cch-agent-presets`.
 * @module @coco-harness/cch-agent-presets/invariant
 */
...
// joins, and the `agent` field `cch-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@coco-harness/cch-agent-presets'

const PACKAGE_NAME = '@coco-harness/cch-agent-presets'
