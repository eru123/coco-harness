...
import AgentRegistry, { assembleContextFor } from '@coco-harness/cch-agent'
import AgentLoop from '@coco-harness/cch-agent-loop'
import InvariantRegistry from '@coco-harness/cch-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@coco-harness/cch-agent-presets'
import * as AgentPresetsInvariant from '@coco-harness/cch-agent-presets/invariant'
