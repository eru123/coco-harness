 ...
 *
 * `cch-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `cch-subagent` installs; mounted globally
 ...
 * @module @coco-harness/cch-persona
 */
...
import { PERSONA_ORDER, PERSONA_SECTION } from '@coco-harness/cch-system-prompt'
