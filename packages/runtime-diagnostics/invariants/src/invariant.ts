/**
 * Package-owned invariant companion for `@coco-harness/cch-invariants`.
 * @module @coco-harness/cch-invariants/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-invariants'
