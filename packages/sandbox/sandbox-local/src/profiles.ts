 ...
 *
 * @module @coco-harness/cch-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@coco-harness/node-addon-landlock-run'
 ...
 * (`@coco-harness/cch-fs-sandbox`) can never drift apart.
