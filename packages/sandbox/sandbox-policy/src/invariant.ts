/** Package-owned session-event invariants for sandbox policy. @module @coco-harness/cch-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@coco-harness/cch-sandbox-policy'
