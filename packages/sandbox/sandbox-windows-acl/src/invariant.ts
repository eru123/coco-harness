/**
 * Package-owned invariant companion for `@coco-harness/cch-sandbox-windows-acl`.
 * @module @coco-harness/cch-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-sandbox-windows-acl'
