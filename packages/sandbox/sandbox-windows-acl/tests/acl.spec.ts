 ...
 * is the mandated lock infrastructure under <GetTempPathW()>\cch-acl-locks,
...
const SID_STRUCT = koffi.struct('CCH_ACL_SPEC_SID', {
  revision: 'uint8',
...
describe.skipIf(!isWin32)('ACL editing', () => {
  ...
  function scratch(): string {
    const dir = mkdtempSync(join(tmpdir(), 'cch-acl-edit-'))
