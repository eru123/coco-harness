 ...
 * (`@coco-harness/cch-sandbox-local`) and the in-process filesystem fence
 * (`@coco-harness/cch-fs-sandbox`) both derive their allow-list here, so "the
