/**
 * Package-owned invariant companion for `@coco-harness/cch-sdk-client`.
 * @module @coco-harness/cch-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-sdk-client'
