 ...
 *
 * @module @coco-harness/cch-sdk-client/types
 */
...
export interface HarnessClientOptions {
  /** The runtime executable (the `cch-jsonrpc-agent` bin, a packaged exe, or `node`). */
  command: string
   ...
   * credential policy (see `scrubbedParentEnv` in `@coco-harness/cch-subprocess`
...
/** Options for the high-level {@link CocoHarness} wrapper. */
export interface CocoHarnessOptions {
