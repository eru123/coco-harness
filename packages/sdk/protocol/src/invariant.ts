/**
 * Package-owned invariant companion for `@coco-harness/cch-sdk-protocol`.
 * @module @coco-harness/cch-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-sdk-protocol'
