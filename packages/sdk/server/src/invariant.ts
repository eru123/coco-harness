/**
 * Package-owned invariant companion for `@coco-harness/cch-sdk-jsonrpc-server`.
 * @module @coco-harness/cch-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-sdk-jsonrpc-server'
