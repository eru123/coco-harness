/**
 * Package-owned invariant companion for `@coco-harness/cch-session-query-sqlite`.
 * @module @coco-harness/cch-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-query-sqlite'
