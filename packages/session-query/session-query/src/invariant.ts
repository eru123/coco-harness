/**
 * Package-owned invariant companion for `@coco-harness/cch-session-query`.
 * @module @coco-harness/cch-session-query/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-query'
