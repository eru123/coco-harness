/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-session-query`.
 * @module @coco-harness/cch-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-session-query'
