/**
 * Package-owned invariant companion for `@coco-harness/cch-session-checkpoint-policy`.
 * @module @coco-harness/cch-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-checkpoint-policy'
