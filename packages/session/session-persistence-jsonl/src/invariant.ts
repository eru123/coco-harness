/**
 * Package-owned invariant companion for `@coco-harness/cch-session-persistence-jsonl`.
 * @module @coco-harness/cch-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-persistence-jsonl'
