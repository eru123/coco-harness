 ...
 * @module @coco-harness/cch-session-persistence-sqlite
 */
...
import type { SessionEvent, SurfaceEventType, SessionId, SessionHeader, SessionPreparation } from '@coco-harness/cch-session'
import {
