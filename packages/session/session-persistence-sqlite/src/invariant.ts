/**
 * Package-owned invariant companion for `@coco-harness/cch-session-persistence-sqlite`.
 * @module @coco-harness/cch-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-persistence-sqlite'
