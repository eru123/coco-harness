 ...
 * @module @coco-harness/cch-session-persistence/coordinator
 */
...
import type { Session, SessionEvent, SessionId, SessionHeader } from '@coco-harness/cch-session'
...
export class PersistenceCoordinator<TornMarker = unknown> {
  ...
  private installWritePath(): void {
    ...
    // sessions (mirrors cch-invariants).
