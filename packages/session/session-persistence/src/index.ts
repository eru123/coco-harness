 ...
 * @module @coco-harness/cch-session-persistence
 */

import { Context, Service } from '@coco-harness/cordis'
import { SessionPreparation } from '@coco-harness/cch-session'
import type { SessionEvent, SessionId, SessionHeader } from '@coco-harness/cch-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@coco-harness/cch-session'
