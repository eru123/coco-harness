/**
 * Package-owned invariant companion for `@coco-harness/cch-session-persistence`.
 * @module @coco-harness/cch-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-persistence'
