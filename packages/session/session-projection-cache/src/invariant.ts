/**
 * Package-owned invariant companion for `@coco-harness/cch-session-projection-cache`.
 * @module @coco-harness/cch-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-projection-cache'
