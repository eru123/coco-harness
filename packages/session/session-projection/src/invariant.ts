/**
 * Package-owned invariant companion for `@coco-harness/cch-session-projection`.
 * @module @coco-harness/cch-session-projection/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-projection'
