/**
 * Package-owned invariant companion for `@coco-harness/cch-session-stats`.
 * @module @coco-harness/cch-session-stats/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-stats'
 ...
 * ids) are owned and runtime-checked by cch-agent-loop and the session
 * surface, not here.
 */
