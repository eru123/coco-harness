/**
 * OpenTelemetry Service Provider for the Coco Harness telemetry capability.
 *
 ...
 *
 * @module @coco-harness/cch-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@coco-harness/schemastery'
import type { Context } from '@coco-harness/cordis'
import type {} from '@coco-harness/cch-command-feedback'
import {
...
} from '@coco-harness/cch-session-telemetry'
import { APP_IDENTITY } from '@coco-harness/cch-llm'
...
// version (same pattern as cch-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@coco-harness/cch-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@coco-harness/cch-session-telemetry-otel/ops', version)
