/**
 * Package-owned invariant companion for `@coco-harness/cch-session-telemetry`.
 * @module @coco-harness/cch-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-telemetry'
