/**
 * Package-owned invariant companion for `@coco-harness/cch-session-title-all-prompts-llm`.
 * @module @coco-harness/cch-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-title-all-prompts-llm'
