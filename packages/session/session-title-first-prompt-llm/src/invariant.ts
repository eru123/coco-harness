/**
 * Package-owned invariant companion for `@coco-harness/cch-session-title-first-prompt-llm`.
 * @module @coco-harness/cch-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-title-first-prompt-llm'
