 ...
 * @module @coco-harness/cch-session-title-llm
 */

import type { Context } from '@coco-harness/cordis'
import z from '@coco-harness/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@coco-harness/cch-llm'
import type { FinishReason, GenerateOptions, Message } from '@coco-harness/cch-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@coco-harness/cch-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@coco-harness/cch-session-title'
import type {
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'cch-session-title-llm' },
  })]
