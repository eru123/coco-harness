/**
 * Package-owned invariant companion for `@coco-harness/cch-session-title-llm`.
 * @module @coco-harness/cch-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-title-llm'
