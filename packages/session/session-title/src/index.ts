 ...
 * @module @coco-harness/cch-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@coco-harness/cordis'
import z from '@coco-harness/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@coco-harness/cch-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@coco-harness/cch-llm'
import type { GenerateOptions } from '@coco-harness/cch-llm'
import type {
  Session,
  SessionEvent,
