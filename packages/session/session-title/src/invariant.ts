/**
 * Package-owned invariant companion for `@coco-harness/cch-session-title`.
 * @module @coco-harness/cch-session-title/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-session-title'
