 ...
 * mirror of `@coco-harness/cch-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @coco-harness/cch-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@coco-harness/cch-shell'
import type { RunnerFailureRule } from '@coco-harness/cch-sandbox'
