 ...
 * `@coco-harness/cch-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * on `ctx.sandboxPolicy` (`@coco-harness/cch-sandbox-policy`), which resolves
