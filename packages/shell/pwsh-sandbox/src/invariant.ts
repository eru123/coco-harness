/**
 * Package-owned invariant companion for `@coco-harness/cch-pwsh-sandbox`.
 * @module @coco-harness/cch-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-pwsh-sandbox'
