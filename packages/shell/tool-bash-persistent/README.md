...
The generated [`bash` schema](../../../docs/tool-catalog.md#coco-harnesscch-tool-bash-persistent), including the configured `description`. The plugin contributes no standalone system-prompt section; the deployment owns persona and environment guidance.
