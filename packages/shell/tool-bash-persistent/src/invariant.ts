/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-bash-persistent`.
 * @module @coco-harness/cch-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-bash-persistent'
