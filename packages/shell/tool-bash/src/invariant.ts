/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-bash`.
 * @module @coco-harness/cch-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-bash'
