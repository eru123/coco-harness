 ...
 *
 * @module @coco-harness/cch-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@coco-harness/cch-shell'
import type { SandboxMode } from '@coco-harness/cch-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@coco-harness/cch-sandbox'
 ...
 * rendering story, owned by `@coco-harness/cch-shell` so `cch-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@coco-harness/cch-shell'
