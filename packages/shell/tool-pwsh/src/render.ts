 ...
 * `cch-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @coco-harness/cch-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@coco-harness/cch-shell'
...
/* jscpd:ignore-start -- deliberate twin of cch-tool-bash/render.ts (Agent Note). */
