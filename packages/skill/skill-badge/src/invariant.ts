/**
 * Package-owned invariant companion for `@coco-harness/cch-skill-badge`.
 * @module @coco-harness/cch-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-skill-badge'
