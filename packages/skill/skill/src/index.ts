 ...
 * Concrete
 * providers such as `@coco-harness/cch-skill-filesystem` decide where skills come
 ...
 *
 * @module @coco-harness/cch-skill
 */

import { Context, Service } from '@coco-harness/cordis'
import { assertNever } from '@coco-harness/cch-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@coco-harness/cch-scope'
import type { ScopeKey, ScopeLayer } from '@coco-harness/cch-scope'
...
export type SkillSource = 'project-cch' | 'project-agents' | 'runtime' | 'user-cch' | 'user-agents' | 'custom' | 'bundled' | (string & {})
