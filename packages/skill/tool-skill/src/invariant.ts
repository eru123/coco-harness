/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-skill`.
 * @module @coco-harness/cch-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-skill'
