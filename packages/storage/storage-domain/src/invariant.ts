/**
 * Package-owned invariant companion for `@coco-harness/cch-storage-domain`: every
 ...
 * @module @coco-harness/cch-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-storage-domain'
