/**
 * Package-owned invariant companion for `@coco-harness/cch-storage-json`.
 * @module @coco-harness/cch-storage-json/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-storage-json'
