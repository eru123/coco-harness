/**
 * Package-owned invariant companion for `@coco-harness/cch-storage-sqlite`.
 * @module @coco-harness/cch-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-storage-sqlite'
