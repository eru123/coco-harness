...
import Storage, { storageBackendServiceKey } from '@coco-harness/cch-storage'
import type { KvUnitDescriptor } from '@coco-harness/cch-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'cch-storage-sqlite-'))
  dirs.push(dir)
