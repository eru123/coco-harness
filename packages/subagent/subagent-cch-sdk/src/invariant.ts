/**
 * Package-owned invariant companion for `@coco-harness/cch-subagent-cch-sdk`.
 * @module @coco-harness/cch-subagent-cch-sdk/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-subagent-cch-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-cch-sdk-invariant'
