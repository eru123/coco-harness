/**
 * Package-owned invariant companion for `@coco-harness/cch-subagent-codex`.
 * @module @coco-harness/cch-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-subagent-codex'
