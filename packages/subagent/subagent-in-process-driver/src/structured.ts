 ...
 * @module @coco-harness/cch-subagent-in-process-driver/structured
 */

import type { Context } from '@coco-harness/cordis'
import type { ToolSchema } from '@coco-harness/cch-llm'
import type { ToolExecution, ToolRunContext } from '@coco-harness/cch-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@coco-harness/cch-tools'
 ...
 *   `assertObjectJsonSchema` in cch-tools).
