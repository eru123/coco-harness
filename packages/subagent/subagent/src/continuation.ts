...
import { boundContextSummary, createUserMessage, errorChain } from '@coco-harness/cch-llm'
import type { ContentBlock, MessageId, MessageSource } from '@coco-harness/cch-llm'
...
import type { ToolRestriction } from '@coco-harness/cch-tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a cch-session-persistence backend)',
