...
import type { SessionProjectionRegistry } from '@coco-harness/cch-session-projection'
import type { SessionProjectionCache } from '@coco-harness/cch-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @coco-harness/cch-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @coco-harness/cch-session)',
