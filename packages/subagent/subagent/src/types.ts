 ...
 *
 * @module @coco-harness/cch-subagent/types
 */

import type { Agent, AgentOptions } from '@coco-harness/cch-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@coco-harness/cch-tools'
