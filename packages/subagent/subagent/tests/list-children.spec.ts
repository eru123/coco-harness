...
import SessionProjectionCache from '@coco-harness/cch-session-projection-cache'
...
import SubagentRuntime, {
  ...
  SubagentError,
} from '@coco-harness/cch-subagent'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'cch-subagent-list-'))
  roots.push(root)
