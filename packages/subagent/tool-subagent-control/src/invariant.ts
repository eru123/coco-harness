/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-subagent-control`.
 * @module @coco-harness/cch-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-subagent-control'
