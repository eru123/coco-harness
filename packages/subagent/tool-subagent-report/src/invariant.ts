/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-subagent-report`.
 * @module @coco-harness/cch-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-subagent-report'
