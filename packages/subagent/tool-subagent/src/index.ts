 ...
 * @module @coco-harness/cch-tool-subagent
 */
...
import type { AgentOptions } from '@coco-harness/cch-agent'
import type { ContentBlock } from '@coco-harness/cch-llm'
import type { JsonValue } from '@coco-harness/cch-session'
import { assertSubagentMaxDepth, settleRun } from '@coco-harness/cch-subagent'
import type { SubagentProvider, SubagentResult, SubagentRun } from '@coco-harness/cch-subagent'
import type { JobOutcome } from '@coco-harness/cch-jobs'
