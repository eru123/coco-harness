/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-subagent`.
 * @module @coco-harness/cch-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-subagent'
