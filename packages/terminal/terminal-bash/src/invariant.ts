/**
 * Package-owned invariant companion for `@coco-harness/cch-terminal-bash`.
 * @module @coco-harness/cch-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-terminal-bash'
