 ...
 * @module @coco-harness/cch-tool-terminal
 */
...
import { TerminalSessionId } from '@coco-harness/cch-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@coco-harness/cch-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @coco-harness/cch-jobs and @coco-harness/cch-tool-jobs')
