/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-terminal`.
 * @module @coco-harness/cch-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-terminal'
