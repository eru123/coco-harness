/**
 * Package-owned invariant companion for `@coco-harness/cch-agent-loop-testkit`.
 * @module @coco-harness/cch-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-agent-loop-testkit'
