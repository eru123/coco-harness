/**
 * Package-owned invariant companion for `@coco-harness/cch-client-test-runtime`.
 * @module @coco-harness/cch-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-client-test-runtime'
