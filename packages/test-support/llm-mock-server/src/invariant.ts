/**
 * Package-owned invariant companion for `@coco-harness/cch-llm-mock-server`.
 * @module @coco-harness/cch-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-llm-mock-server'
