/**
 * Package-owned invariant companion for `@coco-harness/cch-llm-replay`.
 * @module @coco-harness/cch-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-llm-replay'
