/**
 * Package-owned invariant companion for `@coco-harness/cch-loader-smoke`.
 * @module @coco-harness/cch-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-loader-smoke'
