/**
 * Package-owned invariant companion for `@coco-harness/cch-typert-generator`.
 * @module @coco-harness/cch-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-typert-generator'
