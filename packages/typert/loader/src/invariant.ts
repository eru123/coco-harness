/**
 * Package-owned invariant companion for `@coco-harness/cch-typert-loader`.
 * @module @coco-harness/cch-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-typert-loader'
