...
The `@coco-harness/cch-typert-registry/types` subpath contains the pure contribution and record contracts. [`cch-typert-loader`](../loader/README.md) discovers and registers generated host artifacts in Loader compositions; direct `ctx.typert.register()` supports other composition owners.
