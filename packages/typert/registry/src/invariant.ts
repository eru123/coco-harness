/**
 * Package-owned invariant companion for `@coco-harness/cch-typert-registry`.
 * @module @coco-harness/cch-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-typert-registry'
