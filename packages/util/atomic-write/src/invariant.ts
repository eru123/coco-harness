/**
 * Package-owned invariant companion for `@coco-harness/cch-atomic-write`.
 * @module @coco-harness/cch-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-atomic-write'
