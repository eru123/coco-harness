 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in cch-llm (tool-call
 * correlation), the shared agent/session `SessionId` in cch-session, and
 * `JobId` in cch-jobs. Branding is for ids that cross package boundaries and
