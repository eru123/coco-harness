...
`cchHomeDisplay()` names an active root symbolically for user-facing paths: `~/.cch` for the default home, `$CCH_HOME` for any configured home. It never leaks an absolute machine path.
