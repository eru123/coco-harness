/**
 * Package-owned invariant companion for `@coco-harness/cch-launch-environment`.
 * @module @coco-harness/cch-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-launch-environment'
