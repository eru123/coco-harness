/**
 * Package-owned invariant companion for `@coco-harness/cch-native-command`.
 * @module @coco-harness/cch-native-command/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-native-command'
