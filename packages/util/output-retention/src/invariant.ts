/**
 * Package-owned invariant companion for `@coco-harness/cch-output-retention`.
 * @module @coco-harness/cch-output-retention/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-output-retention'
