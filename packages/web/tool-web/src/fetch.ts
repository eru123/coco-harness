...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@coco-harness/cch-tools'
import type { WebFetchBody, WebFetchResult } from '@coco-harness/cch-web'
 ...
 * `@coco-harness/cch-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@coco-harness/cch-tool-call-timeout-policy` to enforce.
