/**
 * `@coco-harness/cch-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @coco-harness/cch-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'coco-harness/0.0.1 (+https://github.com/deepseek-ai)'
