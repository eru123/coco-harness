 ...
 * `@coco-harness/cch-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @coco-harness/cch-web-fetch-http/provider
 */

import { WebError } from '@coco-harness/cch-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@coco-harness/cch-web'
