/**
 * Package-owned invariant companion for `@coco-harness/cch-web-search-deepseek`.
 * @module @coco-harness/cch-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-web-search-deepseek'
