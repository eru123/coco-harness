 ...
 * @module @coco-harness/cch-web-search-deepseek/provider
 */
...
import type {
  ...
  WebSearchResult,
  WebSearchSource,
} from '@coco-harness/cch-web'
import type { CredentialRef } from '@coco-harness/cch-credentials'
import type {} from '@coco-harness/cch-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@coco-harness/cch-llm-deepseek` uses, so this
...
const USER_AGENT = 'coco-harness/0.0.1'
