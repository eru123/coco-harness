/**
 * `@coco-harness/cch-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@coco-harness/cch-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@coco-harness/cch-web`.
 *
 * @module @coco-harness/cch-web-search-exa
 */
...
import type {} from '@coco-harness/cch-web'
import {
  ExaSearchProvider,
