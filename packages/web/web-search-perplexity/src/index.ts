/**
 * `@coco-harness/cch-web-search-perplexity`: registers a Perplexity-backed
 * `WebSearchProvider` with `ctx.web`. A function/namespace plugin (NOT a
 * default-export service): it registers INTO the seam's provider registry, like
 * `@coco-harness/cch-llm-deepseek` registers an adapter into `ctx.llm`.
 *
 * @module @coco-harness/cch-web-search-perplexity
 */
