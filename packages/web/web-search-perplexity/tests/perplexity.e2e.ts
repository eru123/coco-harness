...
import { PerplexitySearchProvider, PERPLEXITY_DEFAULT_BASE_URL, PERPLEXITY_DEFAULT_MAX_TOKENS, PERPLEXITY_DEFAULT_MODEL } from '@coco-harness/cch-web-search-perplexity'
...
maybe('PerplexitySearchProvider real API', () => {
  it('returns a generated answer and sources for a live query', async () => {
    ...
    const result = await provider.search({ query: 'What is Coco Harness?', maxResults: 5 })
