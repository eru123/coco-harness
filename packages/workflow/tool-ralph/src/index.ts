 ...
 * @module @coco-harness/cch-tool-ralph
 */
...
import type { SubagentProvider } from '@coco-harness/cch-subagent'
import { defineTool } from '@coco-harness/cch-tools'
import type { ToolCallView, ToolResultView } from '@coco-harness/cch-tools'
import type { WorkflowResult, WorkflowRun } from '@coco-harness/cch-workflow'
