/**
 * Package-owned invariant companion for `@coco-harness/cch-tool-ralph`.
 * @module @coco-harness/cch-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-tool-ralph'
