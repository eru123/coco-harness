 ...
 * (`@coco-harness/cch-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @coco-harness/cch-tool-workflow
 */
...
import type { ToolCallView, ToolResultView } from '@coco-harness/cch-tools'
import type { ContentBlock } from '@coco-harness/cch-llm'
import type { JsonValue, Session, SessionEventMap } from '@coco-harness/cch-session'
import type {
