/**
 * Package-owned invariant companion for `@coco-harness/cch-workflow-worker-thread`.
 * @module @coco-harness/cch-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@coco-harness/cch-workflow-worker-thread'
