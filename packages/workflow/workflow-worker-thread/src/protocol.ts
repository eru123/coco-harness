 ...
 * @module @coco-harness/cch-workflow-worker-thread/protocol
 */

import type { WorkflowAgentEndInfo, WorkflowAgentInfo, WorkflowResult } from '@coco-harness/cch-workflow'
