...
import type { SubagentCapabilities, SubagentProvider, SubagentResult, SubagentRun, SubagentStartRequest } from '@coco-harness/cch-subagent'
import type { WorkflowMeta, WorkflowResult, WorkflowResultInfo, WorkflowRun, WorkflowRunInfo } from '@coco-harness/cch-workflow'
...
describe('cch-workflow-worker-thread', () => {
  describe('script execution over a real worker thread', () => {
    ...
    it('the unbuilt worker forwards exactly TSX_TSCONFIG_PATH through the scrub: the paths-map pin survives, secrets do not', async () => {
      ...
      // must inherit the pin (or its cch-* imports silently resolve to
