...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@coco-harness/cch-typert-generator'
import type { CordisCatalogPolicy } from '@coco-harness/cch-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@coco-harness/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  cchHomePath: 'not a service: boot-provided root accessor function (typeof cchHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@coco-harness/cordis'` Events merge under
