...
import type { CordisCatalogModel, ServiceMethodEntry } from '@coco-harness/cch-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@coco-harness/cch-tool-cordis/api-catalog', '@coco-harness/cch-cordis-client-runner/client/api-catalog')
