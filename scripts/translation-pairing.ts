...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'python/sdk-runtime/src/coco_harness_runtime/runtime/cch-jsonrpc-agent-*/**',
  'python/sdk-runtime/src/coco_harness_runtime/runtime/node/**',
  'vendor/**',
]
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('python/sdk-runtime/src/coco_harness_runtime/runtime/cch-jsonrpc-agent-')
    || file.startsWith('python/sdk-runtime/src/coco_harness_runtime/runtime/node/')
}
...
const PUBLIC_REPOSITORY_BLOB_ROOT = 'https://github.com/eru123/coco-harness/blob/master/'
