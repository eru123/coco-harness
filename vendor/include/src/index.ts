import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@coco-harness/cordis-plugin-loader'
 ...
 * (`cch --dump-config`) so a dump can never drift from what boots. The input
